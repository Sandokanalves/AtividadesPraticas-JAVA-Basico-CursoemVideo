 ...
 * @author sando
 */
public class IdiomaSitemaSwing extends javax.swing.JFrame {

    /**
     * Creates new form IdiomaSitemaSwing
     */
    public IdiomaSitemaSwing() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Idioma do Sitema:");

        lblIdioma.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lblIdioma.setForeground(new java.awt.Color(153, 0, 153));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IdiomaSitemaSwing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IdiomaSitemaSwing().setVisible(true);
            }
        });
    }
